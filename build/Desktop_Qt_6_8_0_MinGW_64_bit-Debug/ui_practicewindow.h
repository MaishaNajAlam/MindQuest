...
public:
    ...
    void setupUi(QMainWindow *practiceWindow)
    {
        if (practiceWindow->objectName().isEmpty())
            practiceWindow->setObjectName("practiceWindow");
        practiceWindow->resize(800, 600);
        practiceWindow->setStyleSheet(QString::fromUtf8("background-color: rgb(255, 255, 255);"));
        centralwidget = new QWidget(practiceWindow);
        centralwidget->setObjectName("centralwidget");
        groupBox = new QGroupBox(centralwidget);
        groupBox->setObjectName("groupBox");
        groupBox->setGeometry(QRect(30, 10, 731, 531));
...
"    color: rgb(50, 30, 100); /* Dark purple */\n"
"    font-weight: bold;\n"
"    background-color: rgb(240, 240, 250); /* Ligh"
                        "t purple background */\n"
"    padding: 5px 10px;\n"
"    border-radius: 5px;\n"
"}\n"
""));
        ...
        questionLabel->setGeometry(QRect(40, 100, 661, 181));
        questionLabel->setWordWrap(true);
        scoreLabel = new QLabel(groupBox);
        scoreLabel->setObjectName("scoreLabel");
        scoreLabel->setGeometry(QRect(20, 470, 141, 41));
        progressBar = new QProgressBar(groupBox);
        progressBar->setObjectName("progressBar");
        progressBar->setGeometry(QRect(600, 10, 118, 23));
        progressBar->setValue(24);
        submit = new QPushButton(groupBox);
        submit->setObjectName("submit");
        submit->setGeometry(QRect(590, 470, 121, 41));
        layoutWidget = new QWidget(groupBox);
        layoutWidget->setObjectName("layoutWidget");
        layoutWidget->setGeometry(QRect(30, 310, 671, 111));
        ...
        menubar = new QMenuBar(practiceWindow);
        menubar->setObjectName("menubar");
        menubar->setGeometry(QRect(0, 0, 800, 22));
        practiceWindow->setMenuBar(menubar);
        statusbar = new QStatusBar(practiceWindow);
        statusbar->setObjectName("statusbar");
        practiceWindow->setStatusBar(statusbar);
    ...
    {
        practiceWindow->setWindowTitle(QCoreApplication::translate("practiceWindow", "MainWindow", nullptr));
        groupBox->setTitle(QString());
        questionLabel->setText(QCoreApplication::translate("practiceWindow", "Q:", nullptr));
        scoreLabel->setText(QCoreApplication::translate("practiceWindow", "Score", nullptr));
        submit->setText(QCoreApplication::translate("practiceWindow", "Submit", nullptr));
        op1->setText(QCoreApplication::translate("practiceWindow", "option1", nullptr));
        op3->setText(QCoreApplication::translate("practiceWindow", "option3", nullptr));
        op2->setText(QCoreApplication::translate("practiceWindow", "option2", nullptr));
        op4->setText(QCoreApplication::translate("practiceWindow", "option4", nullptr));
    } // retranslateUi
